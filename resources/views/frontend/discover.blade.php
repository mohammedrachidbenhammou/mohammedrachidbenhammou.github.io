@include('frontend.shared.master', ['prefs' => ['Discover',1,$info]])
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-60">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Discover Algeria</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.html"></a></li>
              <li class="active">You will like every place </li>
            </ul>
          </div>
          <div class="box-position" style="background-image: url({{asset('images/zyro-image.png')}});"></div>
        </div>
      </section>
      <!-- Why choose us-->
